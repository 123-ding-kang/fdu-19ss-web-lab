...
function test() {
    ...
    console.log("输入：15516718796,'19302010048@fudan.edu.cn'");
    testMail(15516718796,'19302010048@fudan.edu.cn');
    console.log("Problem 3");
    console.log("输入：'Is is the iS is cost of of gasoline going up up'");
    testRedundancy('Is is the iS is cost of of gasoline going up up');
    console.log("Problem 4");
    console.log("输入：'7_This_is_a_test','_hs_s_a_es'");
    testKeyBoard('7_This_is_a_test','_hs_s_a_es');
    console.log("Problem 5");
    console.log("输入：'  hello  world!  '");
    testSpecialReverse('  hello  world!  ');
    console.log("Problem 6");
    console.log("输入：[2,7,11,15],9");
    twoSum([2,7,11,15],9);
    console.log("Problem 7");
    console.log("输入：'abbbbb'");
